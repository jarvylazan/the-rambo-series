...
func _ready():
	...
	"en": [
		...
		"Hidden realms twist around the unknown, waiting quietly behind doors... or portals...",
	...
	"fr": [
		...
		"Des royaumes cachés gravitent autour de l’inconnu, tapis derrière des portes... ou des portails...",
